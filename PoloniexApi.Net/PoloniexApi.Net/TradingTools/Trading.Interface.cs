...
namespace Jojatekok.PoloniexAPI
{
    public interface ITrading
    {
        ...
        /// <param name="currencyPair">The currency pair, which consists of the currency being traded on the market, and the base's code.</param>
        Task<IEnumerable<Trade>> GetTradesAsync(CurrencyPair currencyPair);
        ...
        Task<IEnumerable<Trade>> GetTradesAsync(CurrencyPair currencyPair, DateTime startTime, DateTime endTime);
