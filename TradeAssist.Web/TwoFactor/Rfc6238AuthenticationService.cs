...
namespace TradeAssist.Web.TwoFactor
{
    ...
    public static class Rfc6238AuthenticationService
    {
        ...
        public static int ComputeTotp(HashAlgorithm hashAlgorithm, ulong timestepNumber, string modifier)
        {
            ...
            var hash = hashAlgorithm.ComputeHash(ApplyModifier(timestepAsBytes));
        ...
        {
            var sectokenstring = Base32.ToBase32(securityToken);
            Console.Write(sectokenstring);
