    ...
    public static class Base32
    {
        ...
        public static string ToBase32(byte[] input)
        {
            ...
            for (int offset = 0; offset < input.Length;)
            {
                ...
                int numCharsToOutput = GetNextGroup(ref offset, out a, out b, out c, out d, out e, out f, out g, out h);
            ...
            int GetNextGroup(ref int offset, out byte a, out byte b, out byte c, out byte d, out byte e, out byte f, out byte g, out byte h)
            {
                uint b1, b2, b3, b4, b5;
